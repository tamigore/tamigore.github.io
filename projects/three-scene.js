...
if (!container)
  ...
  // Array of model URLs for each grid cell (3x3 = 9). Fill with the default model for now.
  const modelUrls = new Array(9);
  modelUrls[0] = '../assets/3D/Turing.glb';
  modelUrls[1] = '../assets/3D/Raytracer.glb';
  modelUrls[2] = '../assets/3D/Raytracer.glb';
  modelUrls[3] = '../assets/3D/Raytracer.glb';
  modelUrls[4] = '../assets/3D/Raytracer.glb';
  modelUrls[5] = '../assets/3D/Raytracer.glb';
  modelUrls[6] = '../assets/3D/Raytracer.glb';
  modelUrls[7] = '../assets/3D/Raytracer.glb';
  modelUrls[8] = '../assets/3D/Raytracer.glb';
